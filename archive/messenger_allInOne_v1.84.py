# ============================================================
# messenger_allInOne_v1.84  변경 이력
# ============================================================
#
    ...
    def _run_telegram_message_telethon(self, accounts: list):
        ...
        def _do_send_one(acct, peer, msg, idx, total_cnt):
            ...
            if join_first:
                ...
                join_ok = eng.join_group(acct, peer, self._stop)
                # [v1.85 BUG-FIX] join 후 즉시 FROZEN/FloodStop 체크 — 성공 여부와 무관하게
        ...
        if mode == "zigzag":
            _msg_skip_phones: set = set()   # [v1.85] FROZEN/FloodStop 계정 추적
            for idx, row in enumerate(rows):
                if self._is_stopped(): break
                peer = str(row.get("텔레그램링크",
                           row.get("link",
                ...
                # [v1.85] 이미 FROZEN/FloodStop된 계정이면 즉시 스킵
                ...
                # [v1.85] join_first FROZEN/FloodStop 즉시 탈출
